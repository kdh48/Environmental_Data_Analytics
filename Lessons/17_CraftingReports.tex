...
\begin{longtable}[]{@{}ll@{}}
\toprule
\textbf{Name} & \textbf{Data Description}\tabularnewline
\midrule
\endhead
EPA Air O3 & From NC 2017 \& 2018\tabularnewline
EPA PM2.5 & From NC 2017 \& 2018\tabularnewline
NTL-LTER Lakes & Includes Nutrients \& Chem\tabularnewline
\bottomrule
\end{longtable}
...
\caption{Total Nitrogen Summary Table}\tabularnewline
\toprule
meanTN & minTN & maxTN & sdTN\tabularnewline
\midrule
\endfirsthead
\toprule
meanTN & minTN & maxTN & sdTN\tabularnewline
...
\begin{longtable}[]{@{}rrrr@{}}
\caption{Total Phosphorous Summary Table}\tabularnewline
\toprule
meanTP & minTP & maxTP & sdTP\tabularnewline
\midrule
\endfirsthead
\toprule
meanTP & minTP & maxTP & sdTP\tabularnewline
...
figures. \textless{} IGNORE: In addition, customize the chunk options
such that the figures are aligned on the left side of the page.
\textgreater{} Lastly, add a fig.cap chunk option to add a caption
(title) to your plot that will display underneath the figure.
