...
riverdata$Name <- str_replace(riverdata$Name, "\\[.*\\]", "") #from stack overflow, removes anything with brackets and replaces it with nothing
...
# Turn numeric values from character to numeric, which will turn blanks in to n/as
